const Footer = () => {
  ...
  return (
    <footer className="text-white font-serif">
      <div className="mx-auto flex md:items-center bg-[#111827]">
        <div className="w-1/2 font-medium mx-auto text-center bg-[#1F2937] py-24">
          <h1 className=" text-[32px] text-center mb-6">Contact Us</h1>
        ...
        <div className="w-1/2 text-center font-medium bg-[#111827]">
